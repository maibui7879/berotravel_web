...
export default function CategoryPlaces({ userLocation }) {
  ...
  return (
    <section className=" bg-gradient-to-r from-blue-500 to-blue-10 relative w-full pl-4 md:pl-12 py-12 rounded-2xl shadow-lg my-4 md:my-8">
      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 relative">
        ...
        <div className="md:w-1/3 flex flex-col justify-start gap-4 order-1 md:order-2">
          <h2 className="text-3xl md:text-4xl mr-12 font-extrabold text-gray-800 text-right text-blue-900">
            Khám phá theo loại địa điểm
          </h2>
          <p className="text-gray-600 text-sm mr-12 md:text-base text-right text-blue-900">
