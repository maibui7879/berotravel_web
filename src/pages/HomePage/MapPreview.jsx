  ...
  return (
    <section className="w-full pl-4 md:pl-12 bg-gradient-to-r from-green-50 to-green-100 rounded-2xl shadow-lg">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6">
        ...
        <div className="md:w-1/3 flex flex-col justify-center gap-4 mt-10">
          ...
          <button
            onClick={() => navigate("/")}
            className="mt-2 bg-blue-500 text-white py-2 px-5 rounded-xl hover:bg-white hover:text-blue-500 border border-blue-500 transition-all duration-300 shadow-md hover:shadow-lg w-1/2 mx-auto md:mx-0 text-sm md:text-base"
          >
            Khám phá Map
          </button>
        </div>
